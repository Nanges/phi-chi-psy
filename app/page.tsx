...
export default function Home() {
  return <CitationLayout>
    <main className="container">
      ...
      <p className="mb-3">Cependant, des évènements particuliers peuvent ébranler l’édifice. Les stratégies utilisées ou le soutien apporté deviennent inefficaces. Une aide extérieure devient alors nécessaire.</p>
